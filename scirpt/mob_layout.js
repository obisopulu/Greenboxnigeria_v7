	...
	document.getElementsByClassName("body")[0].style.height=window.innerHeight-153+'px';

function fold(){document.getElementsByClassName("body")[0].style.height=window.innerHeight-153+'px';}
